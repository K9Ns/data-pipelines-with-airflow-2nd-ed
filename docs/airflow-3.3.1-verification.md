...
**3.3.1 비호환으로 확인된 예제 코드는 없습니다.** 임포트 실패는 전부 장 전용 의존성이나 실행 환경 요건이었고, 충족 후 재검사에서 해소되었습니다.
...
| chapter11 | DAG 없음 | 해당 없음 | docker/kubernetes 구성만 있는 장 |
| chapter12 | 9 | 통과 | |
| chapter13 | 1 | 통과 | `geopandas`, `minio` 설치와 `PYTHONPATH=src` 필요 |
| chapter14 | 2 | 통과 | |
| chapter15 | 5 | 4 통과, 1 구성 필요 | Edge 익스큐터 예제(아래 발견 3) |
| chapter16 | DAG 없음 | 해당 없음 | 보안 구성 예제 모음 |
| chapter17 | 1 | 통과 | |
